...
import okd from '../assets/okdprofile.png'
import marms from '../assets/marmsprofile.png'
            ...
            <div className='design-project'>
                ...
                <div className='gallery-container'>
                    <div className={`gallery ${isVisible ? "show" : "hide"}`}>
                        ...
                        <div className='gallery-content grid1'>
                            <div className='box profile1 hidden hidden-up'><img src={profileGallery[0].icon} alt=""/></div>
                            <div className='box profile2 hidden hidden-up'><img src={profileGallery[5].icon} alt=""/></div>
                            <div className='box profile3 hidden hidden-up'><img src={profileGallery[3].icon} alt=""/></div>
                            <div className='box profile4 hidden hidden-up'><img src={profileGallery[6].icon} alt=""/></div>
                            <div className='box profile5 hidden hidden-up'><img src={profileGallery[4].icon} alt=""/></div>
                            <div className='box profile6 hidden hidden-up'><img src={profileGallery[1].icon} alt=""/></div>
                            <div className='box profile7 hidden hidden-up'><img src={profileGallery[2].icon} alt=""/></div>
                            <div className='box profile8 hidden hidden-up'><img src={profileGallery[7].icon} alt=""/></div>
                            <div className='box profile9 hidden hidden-up'><img src={profileGallery[8].icon} alt=""/></div>
                        </div>
                        <div className='gallery-content grid2'>
                            <div className='box okd1 hidden hidden-up'><img src={okdGallery[0].icon} alt=""/></div>
                            <div className='box okd2 hidden hidden-up'><img src={okdGallery[7].icon} alt=""/></div>
                            <div className='box okd3 hidden hidden-up'><img src={okdGallery[2].icon} alt=""/></div>
                            <div className='box okd4 hidden hidden-up'><img src={okdGallery[3].icon} alt=""/></div>
                            <div className='box okd5 hidden hidden-up'><img src={okdGallery[4].icon} alt=""/></div>
                            <div className='box okd6 hidden hidden-up'><img src={okdGallery[5].icon} alt=""/></div>
                            <div className='box okd7 hidden hidden-up'><img src={okdGallery[6].icon} alt=""/></div>
                            <div className='box okd8 hidden hidden-up'><img src={okdGallery[1].icon} alt=""/></div>
                            <div className='box okd9 hidden hidden-up'><img src={okdGallery[8].icon} alt=""/></div>
                        </div>
                        <div className='gallery-content grid3'>
                            <div className='box marms1 hidden hidden-up'><img src={marmsGallery[0].icon} alt=""/></div>
                            <div className='box marms2 hidden hidden-up'><img src={marmsGallery[5].icon} alt=""/></div>
                            <div className='box marms3 hidden hidden-up'><img src={marmsGallery[2].icon} alt=""/></div>
                            <div className='box marms4 hidden hidden-up'><img src={marmsGallery[3].icon} alt=""/></div>
                            <div className='box marms5 hidden hidden-up'><img src={marmsGallery[4].icon} alt=""/></div>
                            <div className='box marms6 hidden hidden-up'><img src={marmsGallery[1].icon} alt=""/></div>
                        </div>
                    </div>
                </div>
            </div>
